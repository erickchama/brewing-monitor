...
def get_batch_results(batch_data):
    try:
        ...
        results['fields'] = {
                            ...
                            "estimatedOg":batch_data.get('estimatedOg'),
                            "estimatedFg":batch_data.get('estimatedFg'),
                            "measuredOg":batch_data.get('measuredOg'),
...
def create_recipe(recipe_name):
    try:
        ...
        with open('/home/pi/tilt_IoT_v2/recipes/' + filename, 'w') as file:
